...
function ListaElaboradorEnredo() {
        ...
        if (doc.exists) {
          ...
          if (docData) {
            ...
            `,
              ...
              preConfirm: () => {
                const novoNomeEnInput = document.getElementById(
                  'nomeAutor'
                ) as HTMLInputElement
                const novoNome = novoNomeEnInput.value

                if (!novoNome) {
                  novoNomeEnInput.classList.add('borda') // Adiciona a classe CSS 'red'
                  Swal.showValidationMessage('Por favor, preencha o nome.')
                  return false
                }
                novoNomeEnInput.classList.remove('borda')
                return novoNome
              }
            }).then((result) => {
              if (result.isConfirmed) {
...
export default ListaElaboradorEnredo
