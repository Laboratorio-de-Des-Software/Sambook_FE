    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Sapateiro adicionado com sucesso!')
        })
        .catch((error) => {
          console.error('Erro ao adicionar sapateiro:', error)
        })
    }
  }
        ...
        <div className="col-md-6 mt-3">
          <div className="input-group mb-3">
            <input
              ...
              placeholder="Digite o nome do sapateiro(a)"
