...
function ListaChapeleiro() {
  ...
  function deleteUser(id: string) {
    firebase
      .firestore()
      .collection('chapeleiro_fantasia')
      .doc(id)
      .delete()
      .then(() => {
        setExcluido(id)
    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Chapeleiro adicionado com sucesso!')
        })
        .catch((error) => {
          console.error('Erro ao adicionar chapeleiro:', error)
        })
    }
  }
        ...
        <div className="col-md-6 mt-3">
          <div className="input-group mb-3">
            <input
              ...
              placeholder="Digite o nome do chapeleiro(a)"
...
export default ListaChapeleiro
