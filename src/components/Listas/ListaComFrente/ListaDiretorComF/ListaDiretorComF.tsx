      ...
      .then((doc) => {
        if (doc.exists) {
          ...
          if (docData) {
            ...
            Swal.fire({
              title: 'Editar Coreógrafo(a) e Diretor(a)',
              html: `
              ...
              <p style=" margin-bottom: -20px; text-align: left"><strong style="margin-left: 250px">Nome : </strong><span style="color:red">*</span></p>
               <input id="nome" type="text" class="swal2-input" value="${diretorData.nome}">
              </div>
            `,
              icon: 'info',
              confirmButtonColor: '#000000',
...
export default ListaDiretorComF
