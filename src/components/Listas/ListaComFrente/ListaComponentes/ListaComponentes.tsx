...
function ListaComponentes() {
  ...
  const adicionarComponentes = () => {
    ...
    Swal.fire({
      title: 'Adicionar Componente da Comissão de Frente',
      html: `
        ...
        if (doc.exists) {
          ...
          if (docData) {
            ...
            Swal.fire({
              ...
              html: `
              <p style=" margin-bottom: -20px"><strong>Total de Componentes da Comissão de Frente: </strong><span style="color:red">*</span></p>
              <input id="total" type="number" class="swal2-input" value="${componenteData.total}">
              <p style=" margin-top: 25px; text-align: left"><strong style="margin-left: 100px">Componentes Femininos: </strong><span style="color:red">*</span></p>
  ...
  return (
    <div>
      ...
      <table className="table table-hover table-bordered mt-3 text-center">
        <thead>
          <tr>
            <th scope="col">Total de Componentes da Comissão de Frente</th>
