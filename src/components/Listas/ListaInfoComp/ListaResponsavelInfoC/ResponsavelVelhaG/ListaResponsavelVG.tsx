      ...
      .then((doc) => {
        if (doc.exists) {
          ...
          if (docData) {
            ...
            Swal.fire({
              title: 'Editar Responsável pela Ala da Velha-Guarda',
              html: `
  ...
  return (
    <div>
      <h1 className="block mt-4 text-sm font-medium text-black">
        Responsável pela Ala da Velha-Guarda
      </h1>
      <div className="row">
...
export default ListaResponsavelVG
