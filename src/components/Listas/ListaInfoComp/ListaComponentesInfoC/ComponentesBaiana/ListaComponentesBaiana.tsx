...
function ListaComponentesBaiana() {
        ...
        if (doc.exists) {
          ...
          if (docData) {
            ...
            Swal.fire({
              ...
              html: `
              <div  style="text-align: left">
                <p style=" margin-bottom: -20px"><strong style="margin-left: 50px">Total de Componentes da Ala das Baianas: </strong><span style="color:red">*</span></p>
...
export default ListaComponentesBaiana
