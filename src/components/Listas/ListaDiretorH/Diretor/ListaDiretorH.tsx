        ...
        if (doc.exists) {
          ...
          if (docData) {
            ...
            `,
              ...
              preConfirm: () => {
                const nomeDiretorHInput = document.getElementById(
                  'nomeDiretor'
                ) as HTMLInputElement
                const novoNome = nomeDiretorHInput.value

                if (!novoNome) {
                  nomeDiretorHInput.classList.add('borda') // Adiciona a classe CSS 'red'
                  Swal.showValidationMessage('Por favor, preencha o nome.')
                  return false
                }

                nomeDiretorHInput.classList.remove('borda')
