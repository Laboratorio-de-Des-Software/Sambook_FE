    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Ferreiro adicionado com sucesso!')
        })
        .catch((error) => {
        ...
        <div className="col-md-6 mt-3">
          <div className="input-group mb-3">
            <input
              ...
              placeholder="Digite o nome do ferreiro"
