...
function ListaEletricista() {
  ...
  function deleteUser(id: string) {
    firebase
      .firestore()
      .collection('eletricista_alegoria')
      .doc(id)
      .delete()
      .then(() => {
        setExcluido(id)
    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Eletricista adicionado com sucesso!')
        })
        .catch((error) => {
          console.error('Erro ao adicionar eletricista:', error)
        })
    }
  }
        ...
        <div className="col-md-6 mt-3">
          <div className="input-group mb-3">
            <input
              ...
              placeholder="Digite o nome do cenógrafo"
...
export default ListaEletricista
