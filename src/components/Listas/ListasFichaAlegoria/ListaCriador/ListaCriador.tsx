    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Cenógrafo adicionado com sucesso!')
        })
        .catch((error) => {
          console.error('Erro ao adicionar cenógrafo:', error)
        })
    }
  }
