    ...
    if (texto.trim() !== '') {
      firebase
        ...
        .then(async (docRef) => {
          ...
          await batch.commit()
          limparCampoTexto()
          console.log('Escultor adicionado com sucesso!')
        })
        .catch((error) => {
          console.error('Erro ao adicionar escultor:', error)
        })
    }
  }
